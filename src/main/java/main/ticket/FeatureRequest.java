...
public class FeatureRequest extends Ticket {
    ...
    public static class Builder {
        ...
        public Builder customerDemand(CustomerDemand cd) { this.customerDemand = cd; return this; }

        public FeatureRequest build() { return new FeatureRequest(this); }
    }
    ...
    public ObjectNode toJson(ObjectMapper mapper) {
        ...
        node.put("customerDemand", customerDemand.name());
